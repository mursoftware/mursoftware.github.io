...
Too late![p]
Click within 0.1 second after the message window appears![p]
And...[p]
In this game, there are a few branches.[p]
Take the shortest route![p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
I really yawn at the speed of human computation...[p]
[_tb_end_text]
