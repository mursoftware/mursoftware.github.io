;メッセージレイヤの定義
		...
		[position width=120 height=700 top=100 left=50 ]


		
			[position page=fore margint=10 marginl=10 marginr=20 marginb=10 vertical=true opacity="96" radius="0" color="0x000000" ]
		...
		[position layer="message1" width=120 height=700 top=100 left=50 ]
		[position layer="message1" page=fore margint=5 marginl=10 marginr=10 marginb=10 vertical=true opacity="96" radius="0" color="0x000000" ]
