;メッセージレイヤの定義
		...
		[position width=800 height=180 top=550 left=250 ]


		
			[position page=fore margint=10 marginl=20 marginr=20 marginb=10 vertical=false opacity="180" radius="0" color="0x000000" ]
		

		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=30 y=550 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=800 height=180 top=550 left=250 ]
