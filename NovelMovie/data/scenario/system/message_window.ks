;メッセージレイヤの定義
		...
		[position width=1300 height=120 top=614 left=0 ]


		
			[position page=fore margint=0 marginl=10 marginr=10 marginb=0 vertical=false opacity="180" radius="0" color="0x000000" ]
		...
		[position layer="message1" width=1300 height=120 top=614 left=0 ]
