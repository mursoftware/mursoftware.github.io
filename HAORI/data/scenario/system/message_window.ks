;メッセージレイヤの定義
		...
		[position width=800 height=180 top=540 left=240 ]


		
			[position page=fore margint=45 marginl=10 marginr=20 marginb=10 vertical=false opacity="150" radius="0" color="0x000000" ]
		

		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=260 y=560 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=800 height=180 top=540 left=240 ]
		[position layer="message1" page=fore margint=5 marginl=10 marginr=10 marginb=10 vertical=false opacity="150" radius="0" color="0x000000" ]
